...
class ProductCRUD:
    ...
    async def delete_product(self, product_name: str = None, product_id: str = None) -> None:
...
class ServiceCRUD:
    ...
    async def delete_service(self, service_name: str = None, service_id: str = None) -> None:
